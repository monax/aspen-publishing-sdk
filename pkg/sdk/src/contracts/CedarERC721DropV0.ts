...
export interface CedarERC721DropV0Interface extends utils.Interface {
  functions: {
    ...
    'initialize(address,string,string,string,address[],address,address,uint128,string,address,address)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'baseURIIndices', values: [PromiseOrValue<BigNumberish>]): string;
  ...
  encodeFunctionData(functionFragment: 'encryptedBaseURI', values: [PromiseOrValue<BigNumberish>]): string;
  ...
  encodeFunctionData(functionFragment: 'getClaimConditionById', values: [PromiseOrValue<BigNumberish>]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [IDropClaimConditionV0.ClaimConditionStruct[], PromiseOrValue<boolean>],
  ): string;
  ...
  encodeFunctionData(functionFragment: 'setMaxWalletClaimCount', values: [PromiseOrValue<BigNumberish>]): string;
  ...
  encodeFunctionData(functionFragment: 'walletClaimCount', values: [PromiseOrValue<string>]): string;
...
export type MaxTotalSupplyUpdatedEvent = TypedEvent<[BigNumber], MaxTotalSupplyUpdatedEventObject>;
...
export type MaxWalletClaimCountUpdatedEvent = TypedEvent<[BigNumber], MaxWalletClaimCountUpdatedEventObject>;
...
export type NFTRevealedEvent = TypedEvent<[BigNumber, string], NFTRevealedEventObject>;
...
export type TokensLazyMintedEvent = TypedEvent<[BigNumber, BigNumber, string, string], TokensLazyMintedEventObject>;
...
export type WalletClaimCountUpdatedEvent = TypedEvent<[string, BigNumber], WalletClaimCountUpdatedEventObject>;

export type WalletClaimCountUpdatedEventFilter = TypedEventFilter<WalletClaimCountUpdatedEvent>;

export interface CedarERC721DropV0 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CedarERC721DropV0Interface;
  ...
  functions: {
    ...
    baseURIIndices(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    encryptedBaseURI(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
    ...
    walletClaimCount(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;
  };
  ...
  callStatic: {
    ...
    setMaxWalletClaimCount(_count: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    WalletClaimCountUpdated(wallet?: PromiseOrValue<string> | null, count?: null): WalletClaimCountUpdatedEventFilter;
  };
  ...
  estimateGas: {
    ...
    encryptedBaseURI(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    getClaimConditionById(_conditionId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    baseURIIndices(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    encryptedBaseURI(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    walletClaimCount(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
